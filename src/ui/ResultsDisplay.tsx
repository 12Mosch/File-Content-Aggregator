...
// --- Main ResultsDisplay Component (remains the same as previous version) ---
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({
  ...
  return (
    <div className="mt-6 p-4 border border-border rounded-lg bg-card flex flex-col flex-grow min-h-[300px] overflow-hidden">
      <h3 className="mt-0 mb-4 text-xl font-semibold text-card-foreground shrink-0">{t('heading')}</h3>
