...
self.onmessage = (event: MessageEvent<{ filePath: string; code: string; language: string }>) => {
  ...
  try {
    ...
    console.error(`[Highlight Worker] Error highlighting ${filePath} (lang: ${language}):`, error);
